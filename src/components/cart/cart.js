...
function Cart() {
  ...
  console.log(savedCart[5].data.title)
  return (
    <>
    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        <div class="flex justify-between border-b pb-8">
          ...
          <h2 class="font-semibold text-2xl">No. of Item: {savedCart.length}</h2>
        </div>
        ...
        {
          // savedCart.data &&
          savedCart.map((data)=>{ return(
            <>
              <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> 
            <div class="w-20">
              <img class="h-24" src={data.data.images[0]} alt="" />
            </div>
            <div class="flex flex-col justify-between ml-4 flex-grow">
              <span class="font-bold text-sm">{data.data.title}</span>
              <span class="text-red-500 text-xs">{data.data.brand}</span>
          ...
          <span class="text-center w-1/5 font-semibold text-sm">${data.data.price}</span>
